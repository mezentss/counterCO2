...
Запустите GUI приложение для удобного выбора городов с автодополнением:
...
**Возможности GUI:**
- 🔍 **Автодополнение городов** - при вводе появляются варианты
- 🗺️ **Интуитивный выбор маршрута** - просто начните печатать название города
- 📊 **Наглядные результаты** - цветные карточки для каждого вида транспорта
- 🌱 **Экологические рекомендации** - выделение самых экологичных вариантов
- ⚙️ **Настройка API** - возможность указать ключ для точных маршрутов
...
├── co2_gui.py            # Графический интерфейс (GUI)
├── co2_cli.py            # Интерфейс командной строки (CLI)
